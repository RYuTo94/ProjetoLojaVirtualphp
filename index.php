            ...
            <div class="col-md-4 mt-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <h4 href="text-success"> R$<?php echo $produto["preco"]; ?></h4>
...
<!-- Modal -->
    <?php foreach($produtos as $chave => $produto):?>
    <div class="modal fade" id="<?php echo $produtos['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
